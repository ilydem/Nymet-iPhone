...
- (void)viewDidLoad
{
    ...
    UIImageView *image_View=[[UIImageView alloc]initWithImage:[UIImage imageNamed:@"autobar@2x.png"]];
    image_View.frame=CGRectMake(0, 40, 320, 155);
    ...
    //program
    program_label_auto=[[UILabel alloc]initWithFrame:CGRectMake(192, 45, 100, 20)];
    program_label_auto.backgroundColor=[UIColor clearColor];
    program_label_auto.textAlignment =NSTextAlignmentCenter;
    [self.view addSubview:program_label_auto];
    [program_label_auto release];

    //AM或是PM
    am_pm_label=[[UILabel alloc]initWithFrame:CGRectMake(198, 75, 30, 20)];
    am_pm_label.backgroundColor=[UIColor clearColor];
    am_pm_label.textAlignment =NSTextAlignmentCenter;
    [self.view addSubview:am_pm_label];
    [am_pm_label release];

    
    //SetTime
    program_label_Time=[[UILabel alloc]initWithFrame:CGRectMake(230, 75, 30, 20)];
    program_label_Time.backgroundColor=[UIColor clearColor];
    program_label_Time.textAlignment =NSTextAlignmentCenter;
    ...
    program_miao_Time=[[UILabel alloc]initWithFrame:CGRectMake(278, 75, 30, 20)];
    program_miao_Time.backgroundColor=[UIColor clearColor];
    program_miao_Time.textAlignment =NSTextAlignmentCenter;
