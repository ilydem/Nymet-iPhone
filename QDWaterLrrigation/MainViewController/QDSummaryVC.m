...
//        [list_dic retain];
       ...
       // [cancel_watring_BT setTitle:[data_Arr objectAtIndex:6] forState:UIControlStateNormal];
        ...
        {
            [masterimage setImage:[UIImage imageNamed:@"masterw2"]];
        }
        else
        {
            [masterimage setImage:[UIImage imageNamed:@"masterw1"]];
...
- (void)viewDidLoad
{
    ...
    UIImageView *image_View=[[UIImageView alloc]initWithImage:[UIImage imageNamed:@"title@2x.png"]];
    ...
    masterimage=[[UIImageView alloc]initWithImage:[UIImage imageNamed:@"masterw1"]];
    masterimage.frame=CGRectMake(0, 130, 320, 44);
    [self.view addSubview:masterimage];
    [masterimage release];
    
    Master_BT=[[UIButton alloc]initWithFrame:CGRectMake(260, 141, 50, 20)];
