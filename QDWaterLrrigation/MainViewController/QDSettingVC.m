        ...
        switch ([indexPath section])
        {
            ...
            switch ([indexPath row])
            {
                ...
                case 1:
                    ...
                    Flow_Reset=[[UISwitch alloc]initWithFrame:CGRectMake(225, 7, 20, 20)];
                ...
                switch ([indexPath row])
            {
                    ...
                    Latch_Label=[[UILabel alloc]initWithFrame:CGRectMake(240, 3, 60, 30)];
                ...
                switch ([indexPath row])
            {
                    case 0:
                        cell.selectionStyle=UITableViewCellSelectionStyleNone;
                        [cell.textLabel setNumberOfLines:2];
                        cell.textLabel.text=@"Master Valve Delay                   Time";
                    MasterField=[[UITextField alloc]initWithFrame:CGRectMake(240, 5, 30, 30)];
...
//                    MasterField.layer.cornerRadius = 5;
                    ...
                    UILabel *label_master_Sec=[[UILabel alloc]initWithFrame:CGRectMake(275, 10, 30, 20)];
                    ...
                    ZDTField=[[UITextField alloc]initWithFrame:CGRectMake(240, 5, 30, 30)];
                    ...
                    UILabel *bel=[[UILabel alloc]initWithFrame:CGRectMake(275, 5, 30, 30)];
                    bel.text=@"Min";
        ...
        break;
                ...
                switch ([indexPath row])
            {
                case 0:
                    cell.selectionStyle=UITableViewCellSelectionStyleNone;
                    cell.textLabel.text=@"Input2(Moisture)";
                    Input2_Switch=[[UISwitch alloc]initWithFrame:CGRectMake(220, 10, 40, 20)];
                ...
                case 1:
                    cell.selectionStyle=UITableViewCellSelectionStyleNone;
                    cell.textLabel.text=@"Input3(Rain)";
                    Input3_Switch=[[UISwitch alloc]initWithFrame:CGRectMake(220, 5, 40, 20)];
